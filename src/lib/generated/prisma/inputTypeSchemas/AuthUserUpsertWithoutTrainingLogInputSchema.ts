...
export const AuthUserUpsertWithoutTrainingLogInputSchema: z.ZodType<Prisma.AuthUserUpsertWithoutTrainingLogInput> = z.object({
  update: z.union([ z.lazy(() => AuthUserUpdateWithoutTrainingLogInputSchema),z.lazy(() => AuthUserUncheckedUpdateWithoutTrainingLogInputSchema) ]),
  create: z.union([ z.lazy(() => AuthUserCreateWithoutTrainingLogInputSchema),z.lazy(() => AuthUserUncheckedCreateWithoutTrainingLogInputSchema) ]),
}).strict();
