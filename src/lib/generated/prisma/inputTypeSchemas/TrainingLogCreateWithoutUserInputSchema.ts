...
export const TrainingLogCreateWithoutUserInputSchema: z.ZodType<Prisma.TrainingLogCreateWithoutUserInput> =
  z
    .object({
      id: z.string().cuid().optional(),
      dog: z.lazy(() => DogCreateNestedOneWithoutTrainingLogInputSchema),
      TrainingLogTrick: z
        .lazy(() => TrainingLogTrickCreateNestedManyWithoutTraining_logInputSchema)
        .optional()
    })
    .strict();
