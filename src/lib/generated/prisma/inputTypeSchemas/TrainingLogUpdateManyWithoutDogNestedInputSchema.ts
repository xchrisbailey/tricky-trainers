...
export const TrainingLogUpdateManyWithoutDogNestedInputSchema: z.ZodType<Prisma.TrainingLogUpdateManyWithoutDogNestedInput> = z.object({
...
export default TrainingLogUpdateManyWithoutDogNestedInputSchema;
