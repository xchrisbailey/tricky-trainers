...
export const TrickUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.TrickUncheckedUpdateWithoutUserInput> =
  z
    .object({
      id: z
      ...
      created_on: z
        ...
        .optional(),
      TrainingLogTrick: z
        .lazy(() => TrainingLogTrickUncheckedUpdateManyWithoutTrickNestedInputSchema)
        .optional()
    })
    .strict();
