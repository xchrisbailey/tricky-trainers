...
export const TrainingLogUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.TrainingLogUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => TrainingLogWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => TrainingLogUpdateWithoutUserInputSchema),z.lazy(() => TrainingLogUncheckedUpdateWithoutUserInputSchema) ]),
