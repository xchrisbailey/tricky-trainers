...
export const DogUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.DogUncheckedCreateWithoutUserInput> =
  z
    .object({
      ...
      TrainingLog: z
        .lazy(() => TrainingLogUncheckedCreateNestedManyWithoutDogInputSchema)
        .optional()
    })
    .strict();
