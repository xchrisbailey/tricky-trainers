...
export const AuthUserUpdateOneWithoutTricksNestedInputSchema: z.ZodType<Prisma.AuthUserUpdateOneWithoutTricksNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => AuthUserUpdateWithoutTricksInputSchema),z.lazy(() => AuthUserUncheckedUpdateWithoutTricksInputSchema) ]).optional(),
}).strict();
