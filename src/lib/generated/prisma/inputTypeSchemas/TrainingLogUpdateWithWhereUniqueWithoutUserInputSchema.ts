...
export const TrainingLogUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.TrainingLogUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => TrainingLogWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TrainingLogUpdateWithoutUserInputSchema),z.lazy(() => TrainingLogUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
