...
export const TrainingLogUncheckedCreateNestedManyWithoutDogInputSchema: z.ZodType<Prisma.TrainingLogUncheckedCreateNestedManyWithoutDogInput> = z.object({
...
export default TrainingLogUncheckedCreateNestedManyWithoutDogInputSchema;
