...
export const TrickUpdateOneRequiredWithoutTrainingLogTrickNestedInputSchema: z.ZodType<Prisma.TrickUpdateOneRequiredWithoutTrainingLogTrickNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => TrickUpdateWithoutTrainingLogTrickInputSchema),z.lazy(() => TrickUncheckedUpdateWithoutTrainingLogTrickInputSchema) ]).optional(),
}).strict();
