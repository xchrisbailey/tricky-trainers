...
export const TrainingLogTrickUncheckedUpdateManyWithoutTraining_logNestedInputSchema: z.ZodType<Prisma.TrainingLogTrickUncheckedUpdateManyWithoutTraining_logNestedInput> =
  z
    .object({
      create: z
        .union([
