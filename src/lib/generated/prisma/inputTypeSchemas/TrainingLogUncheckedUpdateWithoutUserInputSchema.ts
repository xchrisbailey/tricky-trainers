...
export const TrainingLogUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.TrainingLogUncheckedUpdateWithoutUserInput> =
  z
    .object({
      id: z
      ...
      dog_id: z
        ...
        .optional(),
      TrainingLogTrick: z
        .lazy(() => TrainingLogTrickUncheckedUpdateManyWithoutTraining_logNestedInputSchema)
        .optional()
    })
    .strict();
