...
export const AuthSessionUncheckedCreateNestedManyWithoutAuth_userInputSchema: z.ZodType<Prisma.AuthSessionUncheckedCreateNestedManyWithoutAuth_userInput> =
  z
    .object({
      create: z
        .union([
...
export default AuthSessionUncheckedCreateNestedManyWithoutAuth_userInputSchema;
