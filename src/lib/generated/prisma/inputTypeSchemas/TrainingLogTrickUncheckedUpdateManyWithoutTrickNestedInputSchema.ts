...
export const TrainingLogTrickUncheckedUpdateManyWithoutTrickNestedInputSchema: z.ZodType<Prisma.TrainingLogTrickUncheckedUpdateManyWithoutTrickNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => TrainingLogTrickUpsertWithWhereUniqueWithoutTrickInputSchema),
          z.lazy(() => TrainingLogTrickUpsertWithWhereUniqueWithoutTrickInputSchema).array()
        ])
        .optional(),
      ...
      update: z
        .union([
          z.lazy(() => TrainingLogTrickUpdateWithWhereUniqueWithoutTrickInputSchema),
          z.lazy(() => TrainingLogTrickUpdateWithWhereUniqueWithoutTrickInputSchema).array()
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TrainingLogTrickUpdateManyWithWhereWithoutTrickInputSchema),
          z.lazy(() => TrainingLogTrickUpdateManyWithWhereWithoutTrickInputSchema).array()
        ])
        .optional(),
      deleteMany: z
        .union([
...
export default TrainingLogTrickUncheckedUpdateManyWithoutTrickNestedInputSchema;
