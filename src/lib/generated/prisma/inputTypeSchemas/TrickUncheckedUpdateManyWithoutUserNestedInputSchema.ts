...
export const TrickUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.TrickUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TrickUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => TrickUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TrickCreateManyUserInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => TrickWhereUniqueInputSchema),z.lazy(() => TrickWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => TrickWhereUniqueInputSchema),z.lazy(() => TrickWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => TrickWhereUniqueInputSchema),z.lazy(() => TrickWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => TrickWhereUniqueInputSchema),z.lazy(() => TrickWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => TrickUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => TrickUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TrickUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => TrickUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TrickScalarWhereInputSchema),z.lazy(() => TrickScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TrickUncheckedUpdateManyWithoutUserNestedInputSchema;
