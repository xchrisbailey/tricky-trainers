...
export const TrainingLogTrickUpdateManyWithoutTraining_logNestedInputSchema: z.ZodType<Prisma.TrainingLogTrickUpdateManyWithoutTraining_logNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => TrainingLogTrickUpsertWithWhereUniqueWithoutTraining_logInputSchema),
          z.lazy(() => TrainingLogTrickUpsertWithWhereUniqueWithoutTraining_logInputSchema).array()
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => TrainingLogTrickUpdateWithWhereUniqueWithoutTraining_logInputSchema),
          z.lazy(() => TrainingLogTrickUpdateWithWhereUniqueWithoutTraining_logInputSchema).array()
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => TrainingLogTrickUpdateManyWithWhereWithoutTraining_logInputSchema),
          z.lazy(() => TrainingLogTrickUpdateManyWithWhereWithoutTraining_logInputSchema).array()
        ])
        .optional(),
      deleteMany: z
        .union([
          z.lazy(() => TrainingLogTrickScalarWhereInputSchema),
          z.lazy(() => TrainingLogTrickScalarWhereInputSchema).array()
        ])
        .optional()
    })
    .strict();

export default TrainingLogTrickUpdateManyWithoutTraining_logNestedInputSchema;
