...
export const TrainingLogTrickWhereInputSchema: z.ZodType<Prisma.TrainingLogTrickWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => TrainingLogTrickWhereInputSchema),
        z.lazy(() => TrainingLogTrickWhereInputSchema).array()
      ])
      .optional(),
    OR: z
      .lazy(() => TrainingLogTrickWhereInputSchema)
      .array()
      .optional(),
    NOT: z
      .union([
    ...
    trick: z
      .union([z.lazy(() => TrickRelationFilterSchema), z.lazy(() => TrickWhereInputSchema)])
      .optional(),
    training_log: z
      .union([
        z.lazy(() => TrainingLogRelationFilterSchema),
        z.lazy(() => TrainingLogWhereInputSchema)
      ])
      .optional()
  })
  .strict();
