...
export const AuthKeyUpdateManyWithWhereWithoutAuth_userInputSchema: z.ZodType<Prisma.AuthKeyUpdateManyWithWhereWithoutAuth_userInput> =
  z
    .object({
      where: z.lazy(() => AuthKeyScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => AuthKeyUpdateManyMutationInputSchema),
        z.lazy(() => AuthKeyUncheckedUpdateManyWithoutAuth_keyInputSchema)
      ])
    })
    .strict();
