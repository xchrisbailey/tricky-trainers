...
export const AuthKeyCreateNestedManyWithoutAuth_userInputSchema: z.ZodType<Prisma.AuthKeyCreateNestedManyWithoutAuth_userInput> =
  z
    .object({
      create: z
        .union([
...
export default AuthKeyCreateNestedManyWithoutAuth_userInputSchema;
