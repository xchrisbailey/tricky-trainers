...
export const DogScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DogScalarWhereWithAggregatesInput> =
  z
    .object({
      AND: z
        .union([
          z.lazy(() => DogScalarWhereWithAggregatesInputSchema),
          z.lazy(() => DogScalarWhereWithAggregatesInputSchema).array()
        ])
        .optional(),
      OR: z
        .lazy(() => DogScalarWhereWithAggregatesInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
