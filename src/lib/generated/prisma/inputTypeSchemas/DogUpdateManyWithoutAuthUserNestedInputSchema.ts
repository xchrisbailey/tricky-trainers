...
export const DogUpdateManyWithoutAuthUserNestedInputSchema: z.ZodType<Prisma.DogUpdateManyWithoutAuthUserNestedInput> = z.object({
...
export default DogUpdateManyWithoutAuthUserNestedInputSchema;
