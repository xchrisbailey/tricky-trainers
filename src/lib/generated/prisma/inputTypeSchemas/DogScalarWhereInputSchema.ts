...
export const DogScalarWhereInputSchema: z.ZodType<Prisma.DogScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DogScalarWhereInputSchema),z.lazy(() => DogScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DogScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => DogScalarWhereInputSchema),z.lazy(() => DogScalarWhereInputSchema).array() ]).optional(),
