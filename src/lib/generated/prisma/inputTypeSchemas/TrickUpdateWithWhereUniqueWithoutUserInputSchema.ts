...
export const TrickUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.TrickUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => TrickWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TrickUpdateWithoutUserInputSchema),z.lazy(() => TrickUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
