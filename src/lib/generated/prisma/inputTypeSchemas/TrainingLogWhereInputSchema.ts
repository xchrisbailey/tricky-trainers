...
export const TrainingLogWhereInputSchema: z.ZodType<Prisma.TrainingLogWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => TrainingLogWhereInputSchema),
        z.lazy(() => TrainingLogWhereInputSchema).array()
      ])
      .optional(),
    OR: z
    ...
    dog: z
      .union([z.lazy(() => DogRelationFilterSchema), z.lazy(() => DogWhereInputSchema)])
      .optional(),
    user: z
