...
export const DogUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.DogUpdateManyWithWhereWithoutUserInput> =
  z
    .object({
      where: z.lazy(() => DogScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => DogUpdateManyMutationInputSchema),
        z.lazy(() => DogUncheckedUpdateManyWithoutDogsInputSchema)
      ])
    })
    .strict();
