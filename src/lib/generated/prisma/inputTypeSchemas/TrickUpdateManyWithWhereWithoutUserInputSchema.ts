...
export const TrickUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.TrickUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => TrickScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TrickUpdateManyMutationInputSchema),z.lazy(() => TrickUncheckedUpdateManyWithoutTricksInputSchema) ]),
}).strict();
