...
export const AuthUserWhereInputSchema: z.ZodType<Prisma.AuthUserWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => AuthUserWhereInputSchema),
        z.lazy(() => AuthUserWhereInputSchema).array()
      ])
      .optional(),
    OR: z
      .lazy(() => AuthUserWhereInputSchema)
      .array()
      .optional(),
    NOT: z
      .union([
