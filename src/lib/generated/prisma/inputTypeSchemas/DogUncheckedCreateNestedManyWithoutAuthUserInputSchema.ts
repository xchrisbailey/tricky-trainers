...
export const DogUncheckedCreateNestedManyWithoutAuthUserInputSchema: z.ZodType<Prisma.DogUncheckedCreateNestedManyWithoutAuthUserInput> = z.object({
...
export default DogUncheckedCreateNestedManyWithoutAuthUserInputSchema;
