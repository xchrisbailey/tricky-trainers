...
export const DogCountOrderByAggregateInputSchema: z.ZodType<Prisma.DogCountOrderByAggregateInput> = z.object({
...
export default DogCountOrderByAggregateInputSchema;
