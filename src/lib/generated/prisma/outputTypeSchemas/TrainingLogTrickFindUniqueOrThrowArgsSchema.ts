...
export const TrainingLogTrickFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TrainingLogTrickFindUniqueOrThrowArgs> = z.object({
...
export default TrainingLogTrickFindUniqueOrThrowArgsSchema;
