...
export const TrainingLogUpdateManyArgsSchema: z.ZodType<Prisma.TrainingLogUpdateManyArgs> = z
  .object({
    data: z.union([
      TrainingLogUpdateManyMutationInputSchema,
      TrainingLogUncheckedUpdateManyInputSchema
    ]),
