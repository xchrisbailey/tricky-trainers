...
export const TrainingLogCreateArgsSchema: z.ZodType<Prisma.TrainingLogCreateArgs> = z.object({
  select: TrainingLogSelectSchema.optional(),
  include: TrainingLogIncludeSchema.optional(),
  data: z.union([ TrainingLogCreateInputSchema,TrainingLogUncheckedCreateInputSchema ]),
}).strict()

export default TrainingLogCreateArgsSchema;
