...
export const TrainingLogTrickUpsertArgsSchema: z.ZodType<Prisma.TrainingLogTrickUpsertArgs> = z.object({
  ...
  create: z.union([ TrainingLogTrickCreateInputSchema,TrainingLogTrickUncheckedCreateInputSchema ]),
