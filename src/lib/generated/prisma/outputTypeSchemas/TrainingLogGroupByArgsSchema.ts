...
export const TrainingLogGroupByArgsSchema: z.ZodType<Prisma.TrainingLogGroupByArgs> = z.object({
  where: TrainingLogWhereInputSchema.optional(),
  orderBy: z.union([ TrainingLogOrderByWithAggregationInputSchema.array(),TrainingLogOrderByWithAggregationInputSchema ]).optional(),
