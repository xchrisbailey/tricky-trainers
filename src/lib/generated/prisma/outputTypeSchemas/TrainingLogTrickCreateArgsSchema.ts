...
export const TrainingLogTrickCreateArgsSchema: z.ZodType<Prisma.TrainingLogTrickCreateArgs> = z.object({
  select: TrainingLogTrickSelectSchema.optional(),
  include: TrainingLogTrickIncludeSchema.optional(),
  data: z.union([ TrainingLogTrickCreateInputSchema,TrainingLogTrickUncheckedCreateInputSchema ]),
}).strict()

export default TrainingLogTrickCreateArgsSchema;
