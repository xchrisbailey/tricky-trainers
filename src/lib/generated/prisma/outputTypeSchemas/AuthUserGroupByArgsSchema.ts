...
export const AuthUserGroupByArgsSchema: z.ZodType<Prisma.AuthUserGroupByArgs> = z
  .object({
    where: AuthUserWhereInputSchema.optional(),
    orderBy: z
      .union([
        AuthUserOrderByWithAggregationInputSchema.array(),
        AuthUserOrderByWithAggregationInputSchema
      ])
      .optional(),
