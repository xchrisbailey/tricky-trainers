...
export const TrainingLogTrickGroupByArgsSchema: z.ZodType<Prisma.TrainingLogTrickGroupByArgs> = z.object({
  where: TrainingLogTrickWhereInputSchema.optional(),
  orderBy: z.union([ TrainingLogTrickOrderByWithAggregationInputSchema.array(),TrainingLogTrickOrderByWithAggregationInputSchema ]).optional(),
