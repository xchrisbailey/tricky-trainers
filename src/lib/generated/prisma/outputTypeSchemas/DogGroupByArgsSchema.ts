...
export const DogGroupByArgsSchema: z.ZodType<Prisma.DogGroupByArgs> = z.object({
  where: DogWhereInputSchema.optional(),
  orderBy: z.union([ DogOrderByWithAggregationInputSchema.array(),DogOrderByWithAggregationInputSchema ]).optional(),
