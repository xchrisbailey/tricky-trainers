...
export const TrainingLogTrickUpdateManyArgsSchema: z.ZodType<Prisma.TrainingLogTrickUpdateManyArgs> =
  z
    .object({
      data: z.union([
        TrainingLogTrickUpdateManyMutationInputSchema,
        TrainingLogTrickUncheckedUpdateManyInputSchema
      ]),
