...
export const TrainingLogTrickFindUniqueArgsSchema: z.ZodType<Prisma.TrainingLogTrickFindUniqueArgs> = z.object({
...
export default TrainingLogTrickFindUniqueArgsSchema;
