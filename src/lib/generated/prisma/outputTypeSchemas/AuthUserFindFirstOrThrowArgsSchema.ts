...
export const AuthUserFindFirstOrThrowArgsSchema: z.ZodType<Prisma.AuthUserFindFirstOrThrowArgs> = z
  .object({
    ...
    orderBy: z
      .union([
        AuthUserOrderByWithRelationInputSchema.array(),
        AuthUserOrderByWithRelationInputSchema
      ])
      .optional(),
    ...
    distinct: z
      .union([AuthUserScalarFieldEnumSchema, AuthUserScalarFieldEnumSchema.array()])
      .optional()
  })
  .strict();

export default AuthUserFindFirstOrThrowArgsSchema;
