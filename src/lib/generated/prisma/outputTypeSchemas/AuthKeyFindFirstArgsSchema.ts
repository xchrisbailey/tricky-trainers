...
export const AuthKeyFindFirstArgsSchema: z.ZodType<Prisma.AuthKeyFindFirstArgs> = z
  .object({
    ...
    distinct: z
      .union([AuthKeyScalarFieldEnumSchema, AuthKeyScalarFieldEnumSchema.array()])
      .optional()
  })
  .strict();

export default AuthKeyFindFirstArgsSchema;
