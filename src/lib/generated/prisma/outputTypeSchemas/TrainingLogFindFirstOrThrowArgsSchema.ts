...
export const TrainingLogFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TrainingLogFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([TrainingLogScalarFieldEnumSchema, TrainingLogScalarFieldEnumSchema.array()])
        .optional()
    })
    .strict();

export default TrainingLogFindFirstOrThrowArgsSchema;
