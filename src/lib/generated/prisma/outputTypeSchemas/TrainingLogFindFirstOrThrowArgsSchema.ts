...
export const TrainingLogFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TrainingLogFindFirstOrThrowArgs> = z.object({
  ...
  distinct: TrainingLogScalarFieldEnumSchema.array().optional(),
}).strict()
