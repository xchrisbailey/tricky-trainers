...
export const TrickFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TrickFindFirstOrThrowArgs> = z.object({
  ...
  distinct: TrickScalarFieldEnumSchema.array().optional(),
}).strict()

export default TrickFindFirstOrThrowArgsSchema;
