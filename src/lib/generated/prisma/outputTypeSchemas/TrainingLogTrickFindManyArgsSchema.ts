...
export const TrainingLogTrickFindManyArgsSchema: z.ZodType<Prisma.TrainingLogTrickFindManyArgs> = z
  .object({
    ...
    distinct: z
      .union([TrainingLogTrickScalarFieldEnumSchema, TrainingLogTrickScalarFieldEnumSchema.array()])
      .optional()
  })
  .strict();
