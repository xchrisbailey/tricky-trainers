...
import { AuthUserCreateInputSchema } from '../inputTypeSchemas/AuthUserCreateInputSchema';
import { AuthUserUncheckedCreateInputSchema } from '../inputTypeSchemas/AuthUserUncheckedCreateInputSchema';
...
export const AuthUserCreateArgsSchema: z.ZodType<Prisma.AuthUserCreateArgs> = z
  .object({
...
export default AuthUserCreateArgsSchema;
