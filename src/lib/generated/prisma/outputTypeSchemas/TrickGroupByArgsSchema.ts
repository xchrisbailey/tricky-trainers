...
export const TrickGroupByArgsSchema: z.ZodType<Prisma.TrickGroupByArgs> = z
  .object({
    where: TrickWhereInputSchema.optional(),
    orderBy: z
      .union([
        TrickOrderByWithAggregationInputSchema.array(),
        TrickOrderByWithAggregationInputSchema
      ])
      .optional(),
