...
export const TrainingLogTrickFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TrainingLogTrickFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([
          TrainingLogTrickScalarFieldEnumSchema,
          TrainingLogTrickScalarFieldEnumSchema.array()
        ])
        .optional()
    })
    .strict();

export default TrainingLogTrickFindFirstOrThrowArgsSchema;
