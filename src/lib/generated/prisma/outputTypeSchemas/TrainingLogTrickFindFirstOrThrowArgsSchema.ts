...
export const TrainingLogTrickFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TrainingLogTrickFindFirstOrThrowArgs> = z.object({
  ...
  distinct: TrainingLogTrickScalarFieldEnumSchema.array().optional(),
}).strict()
