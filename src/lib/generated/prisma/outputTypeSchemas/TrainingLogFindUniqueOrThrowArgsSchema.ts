...
export const TrainingLogFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TrainingLogFindUniqueOrThrowArgs> = z.object({
  select: TrainingLogSelectSchema.optional(),
  include: TrainingLogIncludeSchema.optional(),
  where: TrainingLogWhereUniqueInputSchema,
}).strict()

export default TrainingLogFindUniqueOrThrowArgsSchema;
