...
const Schema: z.ZodType<Prisma.TrickUncheckedCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const TrickUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
