...
const Schema: z.ZodType<Prisma.DogUncheckedCreateNestedManyWithoutAuthUserInput> = z
  .object({
    create: z
      .union([
...
export const DogUncheckedCreateNestedManyWithoutAuthUserInputObjectSchema = Schema;
