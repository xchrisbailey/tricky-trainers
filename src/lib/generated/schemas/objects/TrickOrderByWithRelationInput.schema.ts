...
const Schema: z.ZodType<Prisma.TrickOrderByWithRelationInput> = z
  .object({
    ...
    User: z.lazy(() => AuthUserOrderByWithRelationInputObjectSchema).optional()
  })
  .strict();

export const TrickOrderByWithRelationInputObjectSchema = Schema;
