...
const Schema: z.ZodType<Prisma.TrickUncheckedUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const TrickUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
